...
import com.example.Bakend.security.JwtAuthenticationFilter;
import com.example.Bakend.security.CustomUserDetailsService;
 ...
 * Authentification par token Bearer ; clé HMAC dérivée de app.jwt.secret.
 */
@Configuration
@EnableWebSecurity
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Endpoints publics (authentification, inscription, invitations, santé)
